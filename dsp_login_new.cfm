	...
	<cfquery name="login" datasource="#application.datasource#" dbtype="ODBC">
			SELECT sitename, username, password, loggedin 
			FROM Clients 
			WHERE ID = #application.clientID#
	</cfquery>
	
	
	<cfif login.loggedin eq 1>
	<cfoutput>
		<cflocation url="dsp_new_admin_intro.cfm?cid=#application.clientID#&sn=#application.menu_t#">
	</cfoutput>
	</cfif>


<cfif login.loggedin eq 0>
<cfoutput query="login"><form action="index.cfm?fa=login_new&login=1&cid=#url.cID#&sn=#url.sn#" method="post">
	<center>
<br><br>
		...
		<tr>
 		...
 		<tr>
			...
			<td align="center" bgcolor="ffffcc">
				<font face="Arial, sans-serif" size="2"><b>#login.sitename#</b></font>
			</td>
		</tr>
		<tr>
			<td align="right">
...
<cfif IsDefined("url.login")>
	...
	<cflocation url="dsp_new_admin_intro.cfm?cid=#application.clientID#&sn=#application.menu_t#">
		...
		<cfelse>
		<table width="100%" border="0" cellpadding="3" bgcolor="FFFFCC"><tr><td>
		<cfoutput>
			<font face="Arial, sans-serif" size="2">
		You were not granted administration access for the site: <font color="red">#application.menu_t#</font>.
		 <br><br>
